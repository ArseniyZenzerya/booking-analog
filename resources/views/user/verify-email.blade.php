...
@section('header-extra-info')
    <div class="header-auth">
        <div class="bar">
            <h1 class="big-text">На вашу пошту прийде ліст з підтвердженням e-mail</h1>
            <b class="big-text"><a class="white-link" href="{{route('mail-send')}}"> Натисніть, якщо не прийшов лист</a></b>
        </div>
    </div>
    <script>
        $( function() {
            var availableTags =
                @php
                    echo DB::table('data_about_objects')->where('price', '>', 0)->pluck('city');
                @endphp
            ;
            $( "#tags" ).autocomplete({
        ...
        <div class="content-home">
            ...
            <div class="block-data" style="margin-top: 30px">
                <form action="{{route('find-place')}}" method="post">
                    ...
                    <input type="text" name='countPeople' class="people">
