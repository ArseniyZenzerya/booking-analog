...
@section('content')
    <div class="main">
        <div class="content">
            ...
            @endif
            <form action="{{route('reg-obj-all-data')}}" method="post" class="form">
                @csrf
                <input type="hidden" name="name" value="{{$data['nameUser']}}">
                <input type="hidden" name="email" value="{{$data['email']}}">
                <input type="hidden" name="phone" value="{{$data['phoneUser']}}">
                <input type="hidden" name="surname" value="{{$data['surnameUser']}}">
