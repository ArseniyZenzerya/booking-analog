...
document.querySelectorAll('.class-open-block').forEach(function (item) {
...
document.querySelectorAll('.class-open-form').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock2();
  });
});
document.querySelectorAll('.class-open-form2').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock3();
  });
});
document.querySelectorAll('.class-open-form3').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock4();
  });
});
document.querySelectorAll('.class-open-form4').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock5();
  });
});
document.querySelectorAll('.class-open-form5').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock6();
  });
});
document.querySelectorAll('.class-open-form6').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock7();
  });
});
document.querySelectorAll('.class-open-form7').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock8();
  });
});
document.querySelectorAll('.class-open-form8').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock9();
  });
});
document.querySelectorAll('.class-open-form9').forEach(function (item) {
  item.addEventListener('click', function (event) {
    showBlock10();
  });
});
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/application"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/application"], () => (__webpack_require__("./resources/sass/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/application"], () => (__webpack_require__("./resources/css/application.css")))
